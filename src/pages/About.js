            ...
            <main className="page-wrapper">
                ...
                {setCardData(content.Company).map((data, index) => (
                    <div className="area_bg">
                        ...
                        {/* </div>  */}
                        {/* ========= Close This Button On Hover Mouse ========= */}
                    </div>
                ))}
                ...
                <div className="question_section my-5">
                    <div className="container">
                        <div className="row">
                            <AboutPara setContetId={setContetId} content={content} getData={getData} />
                        </div>
                    </div>
                ...
                <div className="luxembourg_section my-5">
                    <div className="container">
                        <div className="row">
                            <TimeLine setContetId={setContetId} content={content} getData={getData} />
                        </div>
                    </div>
